...
const ListUserInfor = () => {
  ...
  return (
    ...
    //       </ImageWrapper>
    //       <InforItem >
    //         <DetailItem>Username: {user.userName} </DetailItem>
    //         <DetailItem>Phone: {user.userPhone}</DetailItem>
    //         <DetailItem>Email: {user.userEmail}</DetailItem>
    //         <DetailItem>Address: {user.userAddress}</DetailItem>
    //         <BtnIcon>
    ...
    <ListItem>
      {users.map((user) => (
        <Item key={user.id}>
          ...
          <InforItem>
            <DetailInfor>Username: {user.userName} </DetailInfor>
            <DetailInfor>Phone: {user.userPhone}</DetailInfor>
            <DetailInfor>Email: {user.userEmail}</DetailInfor>
            <DetailInfor>Address: {user.userAddress}</DetailInfor>
            <IconBtn>
              <Button
                className="edit"
                icon="fas fa-edit"
